...
export function classifyLayer(
  ...
  if (
    ...
    packageName.endsWith("-testing")
  ) {
    return "testing";
  }
  if (
    packageName.startsWith("@notrelix/runtime-") ||
    normalized.includes("/packages/runtimes/")
  ) {
    return "runtime";
  }
  if (
  ...
  if (
    ...
    normalized.includes("/src/mobile/") ||
    normalized.includes("/packages/ui/mobile/")
  ) {
    return "mobile";
  }
  if (
    ...
    normalized.includes("/packages/ui/web/")
  ) {
    return "web";
  }
  if (
    normalized.includes("/src/react/") ||
    normalized.includes("/src/query/hooks/") ||
