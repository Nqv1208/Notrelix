...
describe("classifyLayer", () => {
  it("classifies app routes as app layer", () => {
    expect(classifyLayer("/apps/web/src/router.tsx", "@notrelix/app-web")).toBe(
      "app",
    );
  });
  ...
  it("classifies feature folder core as core", () => {
    expect(
      classifyLayer(
        "/packages/features/auth/src/core/index.ts",
  ...
  it("classifies product state api as data", () => {
    expect(
      classifyLayer(
        "/packages/product/work-management/state/src/api/board.api.ts",
  ...
  it("classifies product web package as web", () => {
    expect(
      classifyLayer(
        "/packages/product/work-management/web/src/components/board.tsx",
