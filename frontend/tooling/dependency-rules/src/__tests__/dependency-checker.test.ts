...
describe('AST Architecture Checker Rules', () => {
  it('guards createNotrelixClient invocation sites', () => {
    expect(isForbiddenClientCall('/packages/features/auth/src/index.ts')).toBe(true);
    expect(isForbiddenClientCall('/packages/runtimes/web/src/runtime/app-runtime.tsx')).toBe(false);
    expect(isForbiddenClientCall('/packages/foundation/contracts/src/client/api-client.ts')).toBe(false);
  });
  ...
  it('guards QueryClient instantiation sites', () => {
    expect(isForbiddenQueryClientInstantiation('/packages/features/auth/src/index.ts')).toBe(true);
    expect(isForbiddenQueryClientInstantiation('/packages/foundation/query/src/query-client.ts')).toBe(false);
    expect(isForbiddenQueryClientInstantiation('/packages/runtimes/web/src/runtime/app-runtime.tsx')).toBe(false);
  });
