...
import { KanbanAddCard } from "@/features/work-management/boards/components/views/kanban/kanban-add-card"
import { KanbanCard } from "@/features/work-management/boards/components/views/kanban/kanban-card"
import { KanbanColumnMenu } from "@/features/work-management/boards/components/views/kanban/kanban-column-menu"
    ...
    >
      ...
      <div className="flex shrink-0 items-center justify-between gap-3 border-b border-border bg-card/60 px-3.5 py-3">
        <div className="flex min-w-0 items-center gap-2 flex-1">
          <span className="size-2.5 rounded-full shrink-0" style={{ backgroundColor: group.color ?? "var(--primary)" }} />
          ...
          <Badge variant="secondary" className="rounded-full px-2 py-0.5 text-[10px] font-bold shrink-0 font-body">
            {group.cards.length}
          </Badge>
        </div>
