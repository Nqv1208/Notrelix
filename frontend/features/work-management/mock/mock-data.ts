import type { Board, BoardGroup, BoardMember, Card, FieldDefinition, FieldOption, FullBoardResponse } from "@/features/work-management/types"
...
const members: BoardMember[] = [
  { id: "bm-ana", userId: "user-ana", name: "Ana Moreno", initials: "AM", role: "owner", color: "var(--primary)" },
  { id: "bm-minh", userId: "user-minh", name: "Minh Tran", initials: "MT", role: "editor", color: "var(--color-surface-teal)" },
  { id: "bm-sam", userId: "user-sam", name: "Sam Carter", initials: "SC", role: "editor", color: "var(--color-surface-sunset)" },
  { id: "bm-ivy", userId: "user-ivy", name: "Ivy Chen", initials: "IC", role: "viewer", color: "var(--color-brand-ocean)" },
]

function fieldDefinitions(boardId: string): FieldDefinition[] {
  return [
    { id: `${boardId}-field-title`, boardId, name: "Task", fieldType: "text", options: [], position: 1, isHidden: false, isSystemField: true },
    { id: `${boardId}-field-person`, boardId, name: "Owner", fieldType: "person", options: [], position: 2, isHidden: false, isSystemField: true },
    { id: `${boardId}-field-status`, boardId, name: "Status", fieldType: "select", options: statusOptions, position: 3, isHidden: false, isSystemField: true },
    { id: `${boardId}-field-priority`, boardId, name: "Priority", fieldType: "select", options: priorityOptions, position: 4, isHidden: false, isSystemField: true },
    { id: `${boardId}-field-due-date`, boardId, name: "Due date", fieldType: "date", options: [], position: 5, isHidden: false, isSystemField: true },
    { id: `${boardId}-field-linked-page`, boardId, name: "Doc", fieldType: "linked_page", options: [], position: 6, isHidden: false, isSystemField: false },
    { id: `${boardId}-field-progress`, boardId, name: "Progress", fieldType: "progress", options: [], position: 7, isHidden: false, isSystemField: false },
  ]
}
...
function makeCard(
  ...
  return {
    ...
    isArchived: false,
    isDeleted: false,
    members: [{ id: `cm-${boardId}-${index}`, userId: assignee.userId, name: assignee.name, initials: assignee.initials, color: assignee.color }],
    labels: [{ id: `${boardId}-label-product`, name: "Product", color: "var(--primary)" }],
    checklists: [
      {
...
export const mockBoards = [
  makeBoard("board-product", "Product delivery", "Track delivery work with docs-linked tasks, owners, status, due dates, and progress.", "docs-mvp-spec"),
  makeBoard("board-roadmap", "Roadmap planning", "Prioritize roadmap bets across product, design, engineering, and GTM.", "q3-operating-plan"),
  makeBoard("board-design", "Design QA", "Coordinate design review, implementation QA, and release polish.", "design-system-v2"),
]

export const mockCardComments = [
  { id: "comment-1", cardId: "board-product-card-2", author: "Ana Moreno", body: "Please keep the linked doc updated before review.", createdAt: "2026-05-13T09:12:00.000Z" },
  { id: "comment-2", cardId: "board-product-card-4", author: "Minh Tran", body: "I will sync this with the workspace chat summary.", createdAt: "2026-05-13T09:30:00.000Z" },
  { id: "comment-3", cardId: "board-roadmap-card-3", author: "Sam Carter", body: "Design dependencies are ready for handoff.", createdAt: "2026-05-13T10:00:00.000Z" },
]

export const mockCardActivity = [
  { id: "activity-1", cardId: "board-product-card-2", actor: "Ana Moreno", action: "changed status to Working on it", createdAt: "2026-05-13T09:18:00.000Z" },
  { id: "activity-2", cardId: "board-product-card-4", actor: "Minh Tran", action: "linked Docs MVP specification", createdAt: "2026-05-13T09:34:00.000Z" },
  { id: "activity-3", cardId: "board-roadmap-card-3", actor: "Sam Carter", action: "added checklist items", createdAt: "2026-05-13T10:08:00.000Z" },
]
