...
import { sampleWorkspaces } from "../../shared/mock/sample-data"
import { isMockModeEnabled } from "@/lib/config/mock-mode"
import type { Page, Workspace } from "../../shared/types/document.types"
...
export const useEditorStore = create<LegacyEditorState>((set, get) => ({
  workspaces: isMockModeEnabled("docs") ? sampleWorkspaces : [],
