...
import { useToggleFavorite } from "../../tree/hooks/queries/use-favorites"
...
export function PageToolbar({ page, workspaceId }: PageToolbarProps) {
  ...
  return (
    <div className="sticky top-14 z-30 flex h-14 items-center justify-between border-b border-border bg-card/90 px-4 backdrop-blur-xl">
      <div className="flex min-w-0 items-center gap-2">
        <Link href={`/${workspaceId}/docs`} className="text-sm font-medium text-muted-foreground hover:text-foreground">
          Docs
        </Link>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem asChild>
              <Link href={`/${workspaceId}/docs/${page.id}/history`}>
