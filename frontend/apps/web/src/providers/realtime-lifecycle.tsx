...
export function RealtimeLifecycle({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const unsubscribeEvents = runtime.realtime.subscribe({ workspaceId }, (envelope) => {
      void registry.dispatch(envelope, {
        workspaceId,
  ...
  }, [isAuthenticated, queryClient, registry, runtime.realtime, runtime.telemetry, workspaceId]);
