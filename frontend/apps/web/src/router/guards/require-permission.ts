import type { Permission, PermissionResourceContext } from '@notrelix/platform/permissions-core';
...
export function requirePermission(input: {
  ...
  readonly can: (permission: Permission, context?: PermissionResourceContext) => boolean;
}): void {
