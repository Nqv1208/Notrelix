...
export function MarketingFooter() {
  return (
    <footer
      id="resources"
      className="border-t border-[var(--v2-line)] bg-[var(--v2-surface)]"
    >
      <div className="v2-container py-16 sm:py-20">
        <div className="grid gap-12 lg:grid-cols-[1.35fr_2fr]">
          <div className="max-w-xs">
            ...
            <p className="mt-5 text-sm leading-6 text-[var(--v2-muted)]">
              Không gian làm việc hợp nhất để đội ngũ viết, lập kế hoạch và hoàn
              thành công việc cùng nhau.
            </p>
            <a
              href="mailto:hello@notrelix.com"
              className="mt-5 inline-flex items-center gap-1.5 text-sm font-semibold text-[var(--v2-ink)] hover:text-[var(--v2-cobalt)]"
            >
                ...
                <ul className="mt-4 space-y-3">
                  {section.links.map((link) => (
                    <li key={link.label}>
                      <a
                        href={link.href}
                        className="text-sm text-[var(--v2-muted)] transition-colors hover:text-[var(--v2-ink)]"
                      >
                        {link.label}
                      </a>
                    </li>
        ...
        <div className="mt-14 flex flex-col gap-5 border-t border-[var(--v2-line)] pt-6 text-sm text-[var(--v2-muted)] sm:flex-row sm:items-center sm:justify-between">
          <p>
            © {new Date().getFullYear()} Notrelix. Xây dựng cách đội ngũ làm
            việc tốt hơn.
          </p>
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              aria-label="Notrelix trên GitHub"
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              aria-label="Notrelix trên LinkedIn"
              className="transition-colors hover:text-[var(--v2-ink)]"
            >
