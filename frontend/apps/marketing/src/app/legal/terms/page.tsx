    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 max-w-3xl">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
          ...
          <p>
            By accessing or using Notrelix, you agree to be bound by these Terms of Service.
          ...
          <p>
            ...
            Notrelix and are protected by international copyright, trademark, patent, trade secret,
            and other intellectual property laws.
          </p>
          <h2>4. User Content</h2>
          <p>
            You retain ownership of any content you create or upload to Notrelix.
          ...
          <p>
            In no event shall Notrelix be liable for any indirect, incidental, special,
          ...
          <p>
            ...
            <a href="mailto:legal@notrelix.com" className="text-primary hover:underline"> legal@notrelix.com</a>.
          </p>
        </div>
      </div>
    </div>
