...
describe('invariant', () => {
  ...
  it('throws when condition is falsy', () => {
    ...
    expect(() => invariant(undefined, 'undefined is falsy')).toThrow('Invariant violation: undefined is falsy');
    expect(() => invariant('', 'empty string')).toThrow('Invariant violation: empty string');
  });
});
...
describe('assertNonNull', () => {
  ...
  it('throws when value is null', () => {
    expect(() => assertNonNull(null, 'is null')).toThrow('Assertion failed: is null');
  });

  it('throws when value is undefined', () => {
    expect(() => assertNonNull(undefined, 'is undefined')).toThrow('Assertion failed: is undefined');
  });
});
