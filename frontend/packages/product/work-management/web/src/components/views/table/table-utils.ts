import type { BoardTableColumn, Card } from "@notrelix/work-management-core";
...
export function getOptionToneClass(id?: string) {
  ...
  if (lower.includes("done") || lower.includes("completed"))
    return "bg-[var(--badge-done-bg)] text-[var(--badge-done-text)]";
  if (lower.includes("stuck"))
    return "bg-[var(--badge-stuck-bg)] text-[var(--badge-stuck-text)]";
  if (lower.includes("working"))
    return "bg-[var(--badge-working-bg)] text-[var(--badge-working-text)]";
  if (lower.includes("urgent"))
    return "bg-[var(--badge-urgent-bg)] text-[var(--badge-urgent-text)]";
  if (lower.includes("high"))
    return "bg-[var(--badge-high-bg)] text-[var(--badge-high-text)]";
  if (lower.includes("medium"))
    return "bg-[var(--badge-medium-bg)] text-[var(--badge-medium-text)]";
  if (lower.includes("low"))
    return "bg-[var(--badge-low-bg)] text-[var(--badge-low-text)]";
  return "bg-[var(--badge-default-bg)] text-[var(--badge-default-text)]";
}
...
export function getGroupToneClass(title: string) {
  ...
  if (normalized.includes("working") || normalized.includes("completed"))
    return "bg-primary";
