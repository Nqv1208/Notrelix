...
export function TableGroupSection({
  ...
  return (
    <section
      ...
      className={cn(
        "mb-2 overflow-hidden rounded-sm bg-table-bg ring-1 ring-border/30",
            ...
            <div className="border-t border-border/60 pt-3 flex justify-between items-center">
              <div className="flex flex-col gap-0.5">
                ...
                <p className="text-[10px] text-muted-foreground">
                  Xóa nhóm này cùng toàn bộ các thẻ bên trong.
                </p>
              </div>
              <Button
                variant="destructive"
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Bạn có chắc chắn muốn xóa nhóm &ldquo;{group.title}&rdquo;? Tất cả
              các nhiệm vụ trong nhóm này cũng sẽ bị xóa vễn viễn khỏi bảng.
