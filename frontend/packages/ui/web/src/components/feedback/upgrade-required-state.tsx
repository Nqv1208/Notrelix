...
export function UpgradeRequiredState({
  ...
  return (
    <div className={cn("flex min-h-[300px] flex-col items-center justify-center rounded-lg border border-primary/15 bg-primary/5 p-8 text-center space-y-4", className)}>
