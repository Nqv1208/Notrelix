...
export function WorkspaceShell({ workspaceSlug, children }: { workspaceSlug: string; children: ReactNode }) {
    ...
    <div className="min-h-svh bg-app-shell text-foreground">
      ...
      <Sheet>
        ...
        <SheetContent side="left" className="w-[88vw] max-w-[320px] p-0">
          ...
          <WorkspaceSidebar workspaceSlug={workspaceSlug} collapsed={false} onCollapse={() => undefined} inSheet />
        </SheetContent>
      </Sheet>
