...
export function CardLinkedPagePreview({ workspaceSlug, boardId, pageId }: { workspaceSlug: string; boardId: string; pageId: string }) {
  return (
    <section className="rounded-2xl border border-border bg-card p-5">
      ...
      <div className="rounded-xl border border-border bg-muted/40 p-4">
        ...
        <Button variant="outline" size="sm" className="mt-3 bg-card" asChild>
          <Link href={`/${workspaceSlug}/boards/${boardId}?doc=${pageId}` as never}>
            Open in docs panel
