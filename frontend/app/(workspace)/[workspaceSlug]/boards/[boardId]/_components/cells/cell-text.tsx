  ...
  return (
    <div className="min-w-0">
      <div className="flex min-w-0 items-center gap-2">
        ...
        <Link href={`/${params.workspaceSlug}/boards/${params.boardId}/card/${card.id}` as never} className="shrink-0 rounded p-1 text-muted-foreground opacity-0 transition hover:bg-muted hover:text-foreground group-hover:opacity-100" aria-label={`Open ${card.title}`}>
