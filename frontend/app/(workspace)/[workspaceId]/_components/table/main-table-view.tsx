...
import { defaultTableViewConfig } from "@/features/boards/api/board.api"
import { useBoardTable, useCreateColumn, useCreateGroup, useDeleteCard, useMoveRow, useSelectedCardPanel } from "@/features/boards/hooks"
...
function MainTableToolbar({
  ...
  return (
    <div className="flex min-h-12 shrink-0 flex-wrap items-center gap-2 border-b border-border bg-background px-6 py-2">
...
function AddGroupAction() {
  return (
    <div className="sticky left-0 flex min-h-12 items-center border-b border-border bg-background px-4">
