...
export function CardSidebar({ card, workspaceId, boardId }: { card: Card; workspaceId: string; boardId: string }) {
  return (
      ...
      <section className="space-y-2">
        ...
        {card.linkedPageId ? (
          <Button variant="ghost" size="sm" className="w-full justify-start" asChild>
            <Link href={`/${workspaceId}/boards/${boardId}?doc=${card.linkedPageId}` as never}>
