    ...
    >
      <div className="mb-3 flex items-start gap-2">
        ...
        <div className="min-w-0 flex-1">
          <Link href={`/${params.workspaceId}/boards/${params.boardId}/card/${card.id}` as never} className="line-clamp-2 text-sm font-semibold leading-5 text-foreground hover:text-primary">
            {card.title}
          </Link>
          {card.linkedPageId ? (
