...
import { Layers, FileText, LayoutGrid, CheckSquare, Users, Zap, ArrowRight } from "lucide-react"
...
const features = [
  {
    icon: FileText,
    text: "Block-based docs with slash commands",
  },
  {
    icon: LayoutGrid,
    text: "Kanban boards with drag & drop",
  },
  {
    icon: Users,
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-[1fr_1.1fr]">
      ...
      <div className="relative hidden lg:flex flex-col justify-between overflow-hidden bg-gradient-to-br from-violet-600 via-indigo-600 to-purple-700 p-10 text-white">
        ...
        {/* Logo */}
        <Link href={routes.home} className="relative z-10 flex items-center gap-2.5">
