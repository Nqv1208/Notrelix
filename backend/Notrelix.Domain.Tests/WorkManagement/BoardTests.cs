...
public class BoardTests
{
    ...
    public void Create_ShouldSucceed_WithValidData()
    {
        ...
        var board = Board.Create(workspaceId, createdBy, "My Board", "Description");
    ...
    public void Create_ShouldThrow_WhenTitleIsEmpty()
    {
        ...
        Action act = () => Board.Create(workspaceId, createdBy, "   ", null);
    ...
    {
        var board = Board.Create(Guid.NewGuid(), Guid.NewGuid(), "Old Title", null);
        board.ClearDomainEvents();
        
        var updatedBy = Guid.NewGuid();
        board.Rename("New Title", updatedBy);
    ...
    public void Rename_ShouldThrow_WhenBoardIsDeleted()
    {
        ...
        Action act = () => board.Rename("New Title", Guid.NewGuid());
