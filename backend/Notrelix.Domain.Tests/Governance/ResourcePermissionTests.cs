...
public class ResourcePermissionTests
{
    ...
    {
        var permission = ResourcePermission.Grant(
            ResourceType.Board, Guid.NewGuid(), PermissionSubjectType.User, Guid.NewGuid(), PermissionLevel.Viewer, Guid.NewGuid());
        
        permission.ClearDomainEvents();
        
        var updatedBy = Guid.NewGuid();
        permission.ChangeLevel(PermissionLevel.Editor, updatedBy);
    ...
    {
        var permission = ResourcePermission.Grant(
            ResourceType.Workspace, Guid.NewGuid(), PermissionSubjectType.Team, Guid.NewGuid(), PermissionLevel.Viewer, Guid.NewGuid());
