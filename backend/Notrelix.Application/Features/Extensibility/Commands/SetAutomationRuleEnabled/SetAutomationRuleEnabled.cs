...
namespace Notrelix.Application.Features.Extensibility.Commands.SetAutomationRuleEnabled;

public record SetAutomationRuleEnabledCommand(Guid AutomationRuleId, bool IsEnabled) : IRequest<Result>;
