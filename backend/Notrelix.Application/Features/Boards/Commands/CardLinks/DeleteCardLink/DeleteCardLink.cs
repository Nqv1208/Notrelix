...
public class DeleteCardLinkCommandHandler : IRequestHandler<DeleteCardLinkCommand, Result>
{
    public Task<Result> Handle(DeleteCardLinkCommand request, CancellationToken cancellationToken)
    {
