...
public class ResourcePermissionLifecycleTests
{
    ...
    {
        var permission = ResourcePermission.Grant(WsA, ResourceType.Board, Guid.NewGuid(), PermissionSubjectType.User, Actor, PermissionLevel.Editor, PermissionLevel.Owner, Actor, Now);
