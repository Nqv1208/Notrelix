...
public class BoundaryTests
{
    ...
    {
        var act = () => Workspace.Create(Guid.NewGuid(), Guid.NewGuid(), "", "my-workspace", DateTimeOffset.UtcNow);
    ...
    {
        var act = () => Workspace.Create(Guid.NewGuid(), Guid.NewGuid(), null!, "my-workspace", DateTimeOffset.UtcNow);
    ...
    {
        var act = () => Workspace.Create(Guid.NewGuid(), Guid.NewGuid(), "My Workspace", null!, DateTimeOffset.UtcNow);
