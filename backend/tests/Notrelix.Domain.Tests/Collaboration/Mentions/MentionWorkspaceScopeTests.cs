...
public class MentionWorkspaceScopeTests
{
    ...
    public void Create_WithMatchingWorkspace_ShouldSucceed()
    {
        ...
        var mention = Mention.Create(Guid.NewGuid(), WsA, source, MentionType.User, Guid.NewGuid(), Guid.NewGuid(), DateTimeOffset.UtcNow);
    ...
    public void Create_WithMismatchedWorkspace_ShouldThrow()
    {
        ...
        var act = () => Mention.Create(Guid.NewGuid(), WsA, source, MentionType.User, Guid.NewGuid(), Guid.NewGuid(), DateTimeOffset.UtcNow);
