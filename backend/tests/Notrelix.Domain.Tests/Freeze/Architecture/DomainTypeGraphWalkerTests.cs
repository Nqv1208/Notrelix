...
public class DomainTypeGraphWalkerTests
{
    ...
    {
        var referenced = DomainTypeGraphWalker.GetReferencedTypes(typeof(MyGenericType));
    ...
    {
        var referenced = DomainTypeGraphWalker.GetReferencedTypes(typeof(CycleTypeA));
    ...
    {
        var referenced = DomainTypeGraphWalker.GetReferencedTypes(typeof(FieldTypeHolder));
        referenced.Should().Contain(t => t == typeof(SomeValue));
    }
    ...
    {
        var referenced = DomainTypeGraphWalker.GetReferencedTypes(typeof(PropertyTypeHolder));
        referenced.Should().Contain(t => t == typeof(SomeValue));
    }
    ...
    {
        var referenced = DomainTypeGraphWalker.GetReferencedTypes(typeof(MethodReturnTypeHolder));
        referenced.Should().Contain(t => t == typeof(SomeValue));
    }
    ...
    {
        var referenced = DomainTypeGraphWalker.GetReferencedTypes(typeof(MethodParameterHolder));
        referenced.Should().Contain(t => t == typeof(SomeValue));
    }
