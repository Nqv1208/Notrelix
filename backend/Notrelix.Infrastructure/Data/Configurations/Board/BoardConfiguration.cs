...
namespace Notrelix.Infrastructure.Data.Configurations.Board;

public class BoardConfiguration : IEntityTypeConfiguration<Domain.Entities.Board.Board>
{
    public void Configure(EntityTypeBuilder<Domain.Entities.Board.Board> builder)
    {
