...
public class WorkspacePermissionService : IWorkspacePermissionService
{
    ...
    public async Task<bool> CanViewWorkspaceAsync(Guid workspaceId, Guid userId, CancellationToken cancellationToken = default)
    {
        ...
        var decision = await _permissionEvaluator.EvaluateAsync(
            new PermissionContext(userId, workspaceId, ResourceType.Workspace, null, PermissionAction.ViewWorkspace, PermissionScope.Workspace),
            cancellationToken);
    ...
    public async Task<bool> CanEditWorkspaceAsync(Guid workspaceId, Guid userId, CancellationToken cancellationToken = default)
    {
        ...
        var decision = await _permissionEvaluator.EvaluateAsync(
            new PermissionContext(userId, workspaceId, ResourceType.Workspace, null, PermissionAction.ManageWorkspace, PermissionScope.Workspace),
            cancellationToken);
    ...
    public async Task<bool> CanManageWorkspaceAsync(Guid workspaceId, Guid userId, CancellationToken cancellationToken = default)
    {
        ...
        var decision = await _permissionEvaluator.EvaluateAsync(
            new PermissionContext(userId, workspaceId, ResourceType.Workspace, null, PermissionAction.DeleteWorkspace, PermissionScope.Workspace),
            cancellationToken);
    ...
    public async Task<bool> CanEditBoardAsync(Guid boardId, Guid userId, CancellationToken cancellationToken = default)
    {
        ...
        var decision = await _permissionEvaluator.EvaluateAsync(
            new PermissionContext(userId, workspaceId.Value, ResourceType.Board, boardId, PermissionAction.UpdateItem, PermissionScope.Resource),
            cancellationToken);
    ...
    public async Task<bool> CanManageBoardAsync(Guid boardId, Guid userId, CancellationToken cancellationToken = default)
    {
        ...
        var decision = await _permissionEvaluator.EvaluateAsync(
            new PermissionContext(userId, workspaceId.Value, ResourceType.Board, boardId, PermissionAction.ManageBoardPermission, PermissionScope.Resource),
            cancellationToken);
