...
public class RestoreSpaceCommandHandler : IRequestHandler<RestoreSpaceCommand, Result>
{
    private readonly IWorkspaceDbContext _context;
    private readonly ICurrentRequestContext _requestContext;
    private readonly IDateTimeProvider _dateTimeProvider;

    public RestoreSpaceCommandHandler(IWorkspaceDbContext context, ICurrentRequestContext requestContext, IDateTimeProvider dateTimeProvider)
    {
        _context = context;
    ...
    public async Task<Result> Handle(RestoreSpaceCommand request, CancellationToken ct)
    {
        ...
        space.Restore(_requestContext.UserId, _dateTimeProvider.UtcNow);
