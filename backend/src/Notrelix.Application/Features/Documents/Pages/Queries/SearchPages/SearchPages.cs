...
public record SearchPagesQuery(Guid WorkspaceId, string Query) : IQuery<Result<List<PageDto>>>, IAuthenticatedRequest, IReadRequest, IWorkspaceRequest, IRequirePermission
{
