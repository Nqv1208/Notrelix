...
public record UpdateBoardItemStatusCommand(Guid BoardItemId, string Status) : ICommand<Result>, IWriteRequest, IIdempotentRequest, IAuthenticatedRequest, IResourceScopedRequest, IRequirePermission
{
