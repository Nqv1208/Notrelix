...
public class IntegrationSyncCursorConfiguration : IEntityTypeConfiguration<IntegrationSyncCursor>
{
    public void Configure(EntityTypeBuilder<IntegrationSyncCursor> builder)
    {
        ...
        builder.Property(x => x.ResourceKind).HasColumnName("resource_type").IsRequired().HasMaxLength(100);
        ...
        builder.HasIndex(x => new { x.ConnectionId, x.ResourceKind }).HasDatabaseName("idx_integration_sync_cursors_connection_resource");
    }
}
