...
namespace Notrelix.Infrastructure.CrossContext.Identity.Bootstrap;
...
/// </summary>
public sealed class IdentityBootstrapReadAdapter : IIdentityBootstrapReadPort
{
    ...
    public IdentityBootstrapReadAdapter(
