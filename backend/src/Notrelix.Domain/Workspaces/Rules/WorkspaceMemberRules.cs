...
public static class WorkspaceMemberRules
{
    ...
    {
        if (ownerCount <= 1)
            throw new BusinessRuleException(BusinessRuleCodes.Workspaces_Member_CannotActOnLastOwner, "Cannot perform this action on the last owner of the workspace.");
    }
}
