...
def main():
    ...
    q=s.add_parser('plan');q.add_argument('--event-name',required=True);q.add_argument('--ref',default='');q.add_argument('--source-sha',required=True);q.add_argument('--base-sha',default='');q.add_argument('--head-sha',default='');q.add_argument('--before-sha',default='');q.add_argument('--changed-file',action='append');q.add_argument('--full',action='store_true');q.add_argument('--output',type=Path,required=True);q.add_argument('--github-output',action='store_true')
