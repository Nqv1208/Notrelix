...
| `ADR-003` | `architecture-decision` | `Accepted` | `backend-architecture` | `backend`, `backend-api`, `backend-security`, `browser-authentication`, `csrf` | [`backend/docs/decisions/ADR-003-csrf-protection.md`](../../backend/docs/decisions/ADR-003-csrf-protection.md) |
